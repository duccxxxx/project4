...
function genereerMacht() {
    var machtGrondgetal = document.getElementById("macht-grondgetal").value; // De invoer van de gebruiker
    ...
    for(var vermenigvuldiger = 1; vermenigvuldiger <= maxMacht; vermenigvuldiger++) {
        var product = machtGrondgetal * grondgetal;  // We rekenen het product uit van 1 vermenigvuldiging
...
function genereerkwadraat() {
    ...
    for(var vermenigvuldiger = 1; vermenigvuldiger <= maxKwadraat; vermenigvuldiger++ && grondgetal++) {
